...
class OnFootPage extends StatefulWidget {
  const OnFootPage({super.key});

  @override
  State<OnFootPage> createState() => _OnBikePageState();
}

class _OnBikePageState extends State<OnFootPage> {
  @override
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Qadamlar", style: GoogleFonts.poppins(fontSize: 18)),
          centerTitle: true,
        ),
        body: _bikeSection(),
      ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _calendarSection(),
          const Gap(30),
          ElevatedButton(onPressed: ()=> navPush(context,DailyRecipes()) ,child:Text("Daily"))
